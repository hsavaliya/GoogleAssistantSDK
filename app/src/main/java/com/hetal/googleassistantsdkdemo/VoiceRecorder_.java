...
/**
 * Continuously records audio and notifies the {@link VoiceRecorder_.Callback} when voice (or any
 * sound) is heard.
 *
...
public class VoiceRecorder_ {
    ...
    public VoiceRecorder_(@NonNull Callback callback) {
        mCallback = callback;
    }
